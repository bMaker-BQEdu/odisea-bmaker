	...
	<p><?php _e( 'Post is password protected. Enter the password to view any comments.', 'wpbmaker' ); ?></p>
</div>
...
<?php if (have_comments()) : ?>
	...
	<ul>
		<?php wp_list_comments('type=comment&callback=wpbmakercomments'); // Custom callback in functions.php ?>
	</ul>

<?php elseif ( ! comments_open() && ! is_page() && post_type_supports( get_post_type(), 'comments' ) ) : ?>

	<p><?php _e( 'Comments are closed here.', 'wpbmaker' ); ?></p>
