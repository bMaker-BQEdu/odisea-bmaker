            ...
            <div class="d-md-flex justify-content-md-end">
                <div class="dropdown my-4" data-js="stage-selector">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?php echo esc_url( get_category_link( 4 ) ); ?>" data-target="">Todos los hitos</a>
                        <a class="dropdown-item" href="<?php echo esc_url( get_category_link( 4 ) ); ?>?post_type=etapa01" data-target="etapa01">Primer hito</a>
                        <a class="dropdown-item" href="<?php echo esc_url( get_category_link( 4 ) ); ?>?post_type=etapa02" data-target="etapa02">Segundo hito</a>
                        <a class="dropdown-item" href="<?php echo esc_url( get_category_link( 4 ) ); ?>?post_type=etapa03" data-target="etapa03">Tercero hito</a>
                        <a class="dropdown-item" href="<?php echo esc_url( get_category_link( 4 ) ); ?>?post_type=etapa04" data-target="etapa04">Cuarto hito</a>
                        <a class="dropdown-item" href="<?php echo esc_url( get_category_link( 4 ) ); ?>?post_type=etapa05" data-target="etapa05">Quinto hito</a>
                    </div>
                </div>
            </div>
